...
def filter_by_category(loaded_data):
    ...
    input("Press Enter to return...")
# Filtering by category allows users to isolate and export a subset of videos belonging to a specific genre for targeted analysis.
...
def filter_by_channel(loaded_data):
    ...
    print(f"Filtered data exported to {output_path}")
    input("Press Enter to return...")
# Filtering by channel enables the extraction of all trending videos from a specific creator, aiding in channel-specific performance reviews.
...
def filter_by_trending_period(loaded_data):
    ...
    print(f"Filtered data exported to {output_path}")
    input("Press Enter to return...")
# Filtering by trending period isolates videos trending on a specific date, allowing for temporal analysis of trends.
